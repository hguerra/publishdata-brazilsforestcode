...
function Temporal() {
  ...
  const friendlyNames = mapper.getScenarioNamesFriendly();
  ...
  const getScenarioComponent = (): JSX.Element => {
    ...
    if (TimelineOption.DIFFERENCE === state.currentTimelineOption) {
      if (state.currentScenario === friendlyNames.IDC2) {
        return (
      ...
      } else if (state.currentScenario === friendlyNames.FC) {
        return (
      ...
      } else if (state.currentScenario === friendlyNames.FCnoCRA) {
        return (
      ...
      } else if (state.currentScenario === friendlyNames.FCnoSFA) {
        return (
